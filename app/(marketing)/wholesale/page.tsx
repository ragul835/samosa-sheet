...
export default function WholesalePage() { return <><PageIntro path="/wholesale/" eyebrow="Bulk Orders" title="Wholesale samosa sheets for food businesses" copy="Tell us the sheet size, quantity, delivery address and supply frequency you need. Our Chennai team will confirm bulk pricing and availability through WhatsApp." /><Wholesale /></>; }
