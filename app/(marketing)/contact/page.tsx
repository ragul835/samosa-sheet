...
export const metadata: Metadata = { title: `Contact Us in Chennai | ${site.name}`, description: `Contact ${site.name} in Nerkundram, Chennai for retail orders, wholesale enquiries and delivery information.`, alternates: { canonical: "/contact/" } };
