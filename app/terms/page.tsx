...
export default function Terms() {
  return <main className="min-h-screen bg-cream py-16"><article className="container-shell max-w-3xl rounded-2xl bg-white p-6 shadow-soft sm:p-10">
    <Link href="/" className="font-semibold text-leaf-700">← Back to home</Link>
    <h1 className="mt-8 text-4xl font-bold">Terms & Conditions</h1><p className="mt-3 text-sm text-gray-500">Last updated: September 5, 2026</p>
