  ...
  return (
    <header className="bg-cream py-12 sm:py-14 md:py-20">
      <div className="container-shell max-w-4xl text-center">
        ...
        <h1 className="mt-3 break-words text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl md:text-5xl">{title}</h1>
        <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-gray-600 sm:text-lg sm:leading-8">{copy}</p>
      </div>
    </header>
  );
}
